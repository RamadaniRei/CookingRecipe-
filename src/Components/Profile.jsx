...
const Profile = () => {
  return (
    <div className="bg-slate-200 flex flex-col p-20 gap-5 w-screen">
      <div className="flex flex-row bg-orange-200 p-5 justify-between items-center">
        <div className="flex flex-row items-center gap-8 ">
          <img
            src={ProfilePic}
            alt="Profile picture"
            className="h-48 w-48 rounded-full border-4 border-white bg-cover"
          />
        ...
        <div className="flex flex-col break w-72 ">
        ...
        <div className="flex flex-row  bg-red-200 p-5 gap-12 items-center rounded-lg">
